...
def downsample_data(data_array, target_height=128, target_width=256):
...
if __name__ == "__main__":
    ...
    print("\nFiles generated:")
    print("- pytorch_model_predictions.png")
    print("- pytorch_model_training_history.png") 
    print("- pytorch_model_results.json")
    print("=" * 60)
