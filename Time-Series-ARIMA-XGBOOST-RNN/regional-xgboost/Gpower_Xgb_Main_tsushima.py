...
filename = "../regional-averages/mp-tsushima-avg.txt"
...
ax.set_title('Tsushima Optuna_Optimized_Model - Microplastic Concentration Prediction')
plt.legend()
plt.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('Tsushima_Optuna_Optimized_Model.png', dpi=300)
plt.close()
print("Tsushima test prediction plot saved as: Tsushima_Optuna_Optimized_Model.png")
